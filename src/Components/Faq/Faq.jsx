          ...
          <div className="row intro-wrapper">
            ...
            <div className="col-lg-4 col-md-6 col-xs-12">
              <div className="single-intro-text">
                ...
                <p>
                  Registration for TSEC Hacks is completely free, Accomodation
                  and food is completely free for shortlisted teams as well.
                </p>
            ...
            <div className="col-lg-4 col-md-6 col-xs-12">
              <div className="single-intro-text mb-70">
                ...
                <p>
                  ...
                  filling up the Devfolio form in which you would have to
                  mention you and your team details. Registrations end on 20th
                  January 2024
                </p>
